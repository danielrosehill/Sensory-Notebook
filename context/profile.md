...
<!--
Dictated by Daniel. Claude may structure, tidy and ask clarifying follow-ups.
Claude must not invent detail, infer a diagnosis, or fill a gap with plausible
generality.

This is the grounding context for the whole notebook. Answers should be read
against it: a question about noise tolerance answered without reference to what
is recorded here is a worse answer.

Everything on this page is personal experience. None of it is a finding, and it
does not need a citation. Where a section points at a research answer, the
answer carries the citations, not this file.
-->
